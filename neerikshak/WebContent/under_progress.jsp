...
<%  
List<Query> list=QueryDao.getAllUnderProgressQueries();  
...
<tbody>
      <tr>
        ...
        <td><a href="changeToDone.jsp?id=${u.getId()}"><button id="ed" class="btn btn-small" >Successfully Done!! :)</button></a></td>
      </tr>
    </tbody> 
